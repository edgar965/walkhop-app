...
{
    // Timeout bewusst KLEINER als das 5-s-Poll-Intervall (4 s): so bricht eine hängende
    // Anfrage VOR dem nächsten Tick ab, statt dass sich überlappende Anfragen stauen.
